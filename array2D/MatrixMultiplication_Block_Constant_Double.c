...
double Z[100][100];
/*@
logic real tmpsum(AB X, BC Y, integer i, integer j,integer l) =
...
//@ ghost int s1, s2, s3;
    ...
    */
	...
	/*@ loop invariant m == 100 && k == 100 && n == 100 && b == 25 && 0 <= ii < m && 0 <= jj <= n &&
		(\forall integer i1: [0..ii-1]. (\forall integer j1: [0..n-1]. Z[i1][j1] == 0.0)) &&
		    (\forall integer j1: [0..jj-1]. Z[ii][j1] == 0.0);
	*/
    ...
    */
	...
	//@ ghost s2 = 0;
	/*@ loop invariant m == 100 && k == 100 && n == 100 && b == 25 &&
		(\forall integer i1: [ii..ii+b-1]. (\forall integer j1: [jj..n-1]. Z[i1][j1] == 0.0)) &&
